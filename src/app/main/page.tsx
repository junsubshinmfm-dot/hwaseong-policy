...
export default function MainPage() {
  return (
    <main className="min-h-screen bg-[var(--background)] relative overflow-hidden">
      ...
      <div className="relative z-10 pt-16 md:pt-20 min-h-screen flex flex-col lg:flex-row">
        <motion.div
        ...
        <motion.div
          ...
          className="w-full lg:w-[340px] xl:w-[380px] shrink-0 p-3 sm:p-4 lg:p-6 lg:pt-0 lg:pr-8"
        >
          <SidePanel />
        </motion.div>
      </div>
